...
@section('content')
    <div class="box-container">
        ...
        <h1 class="page-title">Комплексное снабжение — Общестрой</h1>
        ...
        <div class="service-container">
            <div class="service-container__content">
                <div class="service-container__content-columns">
                    <div class="service-container__content-column service-container__content-column_big">
                        ...
                        <ul>
                            <li>Сухие смеси, теплоизоляция, древесно-плитные материалы,пеноблок, кирпич</li>
                            <li>Метизы, кровля, сайдинг, водосточные системы</li>
                            <li>Лакокрасочные материалы, ручной инструмент, хозтовары, пены, клей, герметики</li>
                            <li>Напольные покрытия, садовые и сезонные товары</li>
                            <li>Двери входные и межкомнатные</li>
                            <li>Электроинструмент и комплектующие</li>
                            <li>Санфаянс, мебель для ванных комнат, душевые кабины и ванны</li>
                            <li>Керамическая плитка, исскуственный камень, керамогранит</li>
                            <li>Щебень, песок, бетон</li>
                        </ul>
                    </div>
            ...
            <div class="service-container__form-block">
                <form class="service-container__form">
                    ...
                    <input type="hidden" name="type_form" id="type-form" value="Снабжение: Общестрой">
