...
@section('content')
    <div class="box-container">
        ...
        <h1 class="page-title">Комплексное снабжение — Вентялиционное оборудование</h1>
        ...
        <div class="service-container">
            <div class="service-container__content">
                <div class="service-container__content-columns">
                    <div class="service-container__content-column service-container__content-column_big">
                        ...
                        <ul>
                            <li>Кондиционеры бытового и промышленного назначения</li>
                            <li>Вентиляторы бытового и промышленного назначения</li>
                            <li>Воздухораспределители и диффузоры</li>
                            <li>Воздуховоды и вент. каналы (все типы исполнения)</li>
                            <li>Фильтрующие элементы (рукавные, HEPA-фильтры, материал)</li>
                            <li>Промышленные фильтра (вентиляция, аспирация, пылеуборка, пылегазоочистка
                                масленный туман и дым)</li>
                        </ul>
                    </div>
            ...
            <div class="service-container__form-block">
                <form class="service-container__form">
                    ...
                    <input type="hidden" name="type_form" value="Вентиляция">
